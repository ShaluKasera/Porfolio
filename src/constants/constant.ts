...
export const projects = [
  {
    id: 1,
    title: "Miorish - E commerce startup for Handcrafted Candles",
    des: "Miorish is E commerce startup for Handcrafted Candles.",
    img: "/project6.png",
    iconLists: [
      "/next.svg",
      "/tail.svg",
    ...
    link: "https://www.miorish.com",
    demo: "",
  },
  {
    id: 2,
    title: "Graho - Astrology Website for Personalized Horoscope",
    des: "Graho is an startup for Astrology for Personalized Horoscope.",
    img: "/project7.png",
    iconLists: [
      "/next.svg",
      "/tail.svg",
